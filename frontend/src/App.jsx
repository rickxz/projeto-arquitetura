...
export default function App() {
  ...
  const isModern = flags.modern_layout?.enabled
  const isOpsDegraded = flags.ops_degraded_mode?.enabled
  const isVip = flags.vip_discount?.enabled
  const isNewCheckout = flags.new_checkout?.enabled
